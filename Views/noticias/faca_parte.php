    ...
    <div id="radio-pesquisa" class="container pags">
        ...
        <div style="width: 730px;padding:10px;" class="comum">
            ...
            <div class="breadcrumb">
                ...
                <a href="<?php echo BASE; ?>noticias/faca-parte" class="last">Faça parte</a>
            </div>

            <h2 class="titulo">Faça parte</h2>
        ...
        <div class="radio-buttons">
            ...
            <div class="relacionadas mt-10">
                ...
                <ul>
                    ...
                    <li class="active"><a href="<?php echo BASE; ?>noticias/faca-parte">Faça Parte</a></li>
                </ul>
            </div>
        </div>
        <!-- ./RÁDIO, NAVEGAÇÃO RÁPIDA E LINKS -->
