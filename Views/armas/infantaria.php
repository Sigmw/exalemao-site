    ...
    <div id="radio-pesquisa" class="container pags">
        ...
        <div style="width: 730px;padding:10px;" class="comum">
            ...
            <div class="breadcrumb">
                ...
                <a href="<?php echo BASE; ?>armas/infantaria" class="last">Infantaria</a>
            </div>

            <h2 class="titulo">Infantaria</h2>
        ...
        <div class="radio-buttons">
            ...
            <div class="relacionadas mt-10">
                ...
                <ul>
                    <li><a href="<?php echo BASE; ?>armas/artilharia" class="last">Artilharia</a></li>
