    ...
    <div id="radio-pesquisa" class="container pags">
        ...
        <div style="width: 730px;padding:10px;" class="comum">
            ...
            <div class="breadcrumb">
                ...
                <a href="<?php echo BASE; ?>armas">Armas</a>
                <a href="<?php echo BASE; ?>armas/artilharia" class="last">Artilharia</a>
            </div>

            <h2 class="titulo">Artilharia</h2>
        ...
        <div class="radio-buttons">
            ...
            <div class="relacionadas mt-10">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo BASE; ?>armas/cavalaria" class="last">Cavalaria</a></li>
                    <li><a href="<?php echo BASE; ?>armas/infantaria" class="last">Infantaria</a></li>
                </ul>
            </div>
