    ...
    <div id="radio-pesquisa" class="container pags">
        ...
        <div style="width: 730px;padding:10px;" class="comum">
            ...
            <div class="breadcrumb">
                ...
                <a href="<?php echo BASE; ?>#">Companhias</a>
                <a href="<?php echo BASE; ?>departamentos/comunicacao" class="last">Unidade de Comunicação</a>
            </div>

            <h2 class="titulo">Unidade de Comunicação</h2>
        ...
        <div class="radio-buttons">
            <div class="radio">
                <div class="locucao">
                    <p>BOT <span style="color: lightblue;">com</span> Programação normal</p>
                    <status style="color: lightblue;">NO AR</status>
                </div>
                <div class="botoes">
            ...
            <div class="relacionadas mt-10">
                ...
                <ul>
                    <li><a href="<?php echo BASE; ?>departamentos/organizacao">Unidade de Organização</a></li>
                    <li><a href="<?php echo BASE; ?>departamentos/instrucao">Unidade de Instrução</a></li>
