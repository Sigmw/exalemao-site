    ...
    <div id="radio-pesquisa" class="container pags">
        ...
        <div style="width: 730px;padding:10px;" class="comum">
            ...
            <div class="breadcrumb">
                ...
                <a href="<?php echo BASE; ?>departamentos/organizacao" class="last">Unidade de Organização</a>
            </div>

            <h2 class="titulo">Unidade de Organização</h2>
        ...
        <div class="radio-buttons">
            ...
            <div class="relacionadas mt-10">
               ...
               <li><a href="<?php echo BASE; ?>departamentos/instrucao">Unidade de Instrução</a></li>
                    <li><a href="<?php echo BASE; ?>departamentos/comunicacao">Unidade de Comunicação</a></li>
                </ul>
            </div>
