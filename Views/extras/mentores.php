    ...
    <div id="radio-pesquisa" class="container pags">
        ...
        <div class="radio-buttons">
            ...
            <div class="relacionadas mt-10">
                ...
                <ul>
                    <li><a href="<?php echo BASE; ?>extras/quadro-de-acionistas">Quadro de Acionistas</a></li>
                    <!-- <li><a href="<?php echo BASE; ?>extras/mentores">Mentores</a></li> -->
                    <li><a href="<?php echo BASE; ?>extras/ajudantes">Ajudantes</a></li>
                </ul>
            </div>
