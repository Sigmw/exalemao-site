...
<div style="background: linear-gradient(to bottom, transparent 0px, transparent 500px, #ffeb00 500px, #fbff00 100%);margin-top:10px;">
    <div id="radio-forum" class="container">
        ...
        <div>
            ...
            <div class="infos">
                ...
                <?php if (!$acesso->isLogged()): ?>
                    <div id="user">                        
                        <img src="https://www.habbo.com.br/habbo-imaging/avatarimage?user=Yuri-Takahashi&action=std&direction=2&head_direction=2&gesture=sml&size=m" alt="Avatar habbo">
    ...
    <div class="container" id="forum-content">
        <?php if ($topico['status'] == 1 || $topico['status'] == 2): ?>
            <div class="verificado" style="color: beige; border-color: black; background: black;">
        ...
        <?php if ($topico['status'] == 0): ?>
            <div class="nao-verificado" style="color: beige; border-color: black; background: black;">
        ...
        <?php if ($topico['status'] == 3): ?>
            <div class="fechado" style="color: beige; border-color: black; background: black;">
