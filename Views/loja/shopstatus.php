...
<?php elseif($tipo == 2): ?>
    <div class="presenteie">
        ...
        <div style="width:-webkit-fill-available;position: relative;">
            ...
            <img src="http://www.habbo.com.br/habbo-imaging/avatarimage?&user=Yuri-Takahashi&action=std&direction=3&head_direction=4&img_format=png&gesture=std&headonly=1&size=s" alt="Habbo Head" id="user_img_presente" style="position:absolute;right: 0;top: 5px;" />
        </div>
