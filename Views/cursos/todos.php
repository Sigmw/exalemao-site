...
<body>
    ...
    <section class="top h-80">
        <div id="sihb">
            <img src="https://www.habbo.com.br/habbo-imaging/badge/b04064t48164s11104t54114t27111892ed000acb4393c77ffd989ddb3128a.gif" alt="sihb" />
        </div>
            ...
            <div class="d-flex space-between mt-10 loj">
                <div class="loja" style="width:530px;">
                    <h1 style="font-size: 2.5em;margin-top: 0px;margin-bottom: 15px;font-weight: 900;margin-top: 30px;">
                        CENTRAL DE CURSOS
                        <span style="font-weight: 100;"><br />DO SFI</span>
                    </h1>

                    <p>Seja bem-vindo a Central de Cursos do Serviço Federal de Inteligência! Através dessa área você terá a oportunidade de aperfeiçoar seus conhecimentos acessando os nossos cursos disponíveis para todos os Membros da Empresa. Desenvolva novas habilidades e conheça mais o SFI! Bons estudos.</p>
        ...
        <div class="container d-flex at" style="position:relative;">
            ...
            <div class="ml-10 twitter-social">
                <div class="tt-head">
                    ...
                    <span>
                        <h3>SOCIAL SFI</h3>
                        <small>@SFIoficial</small>
                    </span>
                </div>

                <div class="tt-body"></div>

                <a href="https://twitter.com/SFIoficial" id='siga-a-SFI'>Siga o SFI!</a>
            </div>
    ...
    <footer>
        <div class="footer-head">
            <div class="container">
                <div style="width:730px;" class="d-flex space-between align-center">
                    <img src="https://i.imgur.com/nOfwuL2.png" alt="SFI" />
        ...
        <div class="container footer-body">
            <div style="width:840px;height:195px;">
                <h3>SERVIÇO DE FEDERAL DE INTELIGÊNCIA</h3>
            ...
            <div class="d-flex socials align-center">
                <a href="https://facebook.com/SFIoficial">
                    <img src="https://i.imgur.com/ATpfVkX.png" alt="Facebook" /> <strong>/SFIoficial</strong>
                </a>

                <a href="https://instagram.com/SFIoficial">
        ...
        function adquirirCurso(curso) {
            ...
            let table = `<table>
                ...
                <tr>
                    ...
                    <td>
                        <strong>${curso.valor}</strong> SFICoins
                    </td>
                </tr>
