...
class Acesso extends Model
{
    ...
    public function isLogged()
    {
        if (isset($_SESSION['sihb_login'])) {
            ...
            $sql = "SELECT *, 
                ...
                (select patentes.nome from patentes where id = patente_id) as patente_nome,
    ...
    {
        if ($minha_patente == 12 && $patente_id >= 16) {
            return true;
        } elseif($minha_patente == 11 && $patente_id >= 16) {
            return true;
        } elseif($minha_patente == 10 && $patente_id >= 15) {
            return true;
        }
        elseif ($minha_patente == 9 && $patente_id >= 14) {
            return true;
        } elseif ($minha_patente == 8 && $patente_id >= 14) {
            return true;
        } elseif ($minha_patente == 7 && $patente_id >= 13) {
            return true;
        } elseif ($minha_patente == 6 && $patente_id >= 11) {
            return true;
    ...
    public function isExterno($externo, $id_registro)
    {
        ...
        if (intval($registro['patente_id']) <= 7) {
            return true;
        }
