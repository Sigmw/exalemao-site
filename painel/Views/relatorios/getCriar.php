<?php if (in_array($tipo, [1, 2, 4, 5, 6, 9, 10, 11])) : ?>
    <form method="POST" action="<?php echo BASE; ?>relatorios/addRelatorio">
        ...
        <?php elseif ($tipo == 2) : ?>
            ...
            <div class="form-group">
                <label for="responsavel">Responsável por Supervisionar a Ronda</label>
                <select class="form-control" id="responsavel" name="responsavel" required>
                    <option value="">Escolha um Oficial</option>
                    <?php foreach ($executivos as $executivo) : ?>
                        <option value="<?php echo $executivo['nickname']; ?>"><?php echo $executivo['nickname']; ?></option>
        ...
        <?php elseif ($tipo == 10) : ?>
            ...
            <div class="form-group">
                ...
                <input id="premio" type="number" class="form-control" name="premio" placeholder="Prêmio (Em EUROS)" required />
            </div>
        <?php elseif ($tipo == 11) : ?>
...
<?php elseif ($tipo == 3) : ?>
    ...
    <form method="POST" action="<?php echo BASE; ?>relatorios/addRelatorio">
        ...
        <div class="form-group">
            <label for="responsavel">Oficial Responsável por Comprovar o Ato</label>
            <select class="form-control" id="responsavel" name="responsavel" required>
                <option value="">Escolha um Oficial</option>
                <?php foreach ($executivos as $executivo) : ?>
                    <option value="<?php echo $executivo['nickname']; ?>"><?php echo $executivo['nickname']; ?></option>
...
<?php elseif ($tipo == 8) : ?>
    <div class="alert alert-danger alert-dismissible fade show" role="alert">
        Você está tentando acessar um relatório que não tem permissão, os Oficiais foram avisados sobre seu ato.
