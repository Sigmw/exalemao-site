            ...
            <div class="card border-3 border-top border-top-primary" >
                <div class="card-body" style="background: #333;">
                    ...
                    <div class="metric-value d-inline-block">
                       ...
                       <img onmouseover="changeNick(<?php echo $nA['nickname']; ?>)" style="float: left;" src="https://www.habbo.com.br/habbo-imaging/avatarimage?user=<?php echo $nA['nickname']; ?>&action=wav&direction=4&head_direction=4&gesture=sml&size=b">
