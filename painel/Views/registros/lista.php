                        ...
                        <table id="example" class="table table-striped table-bordered second dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Sihbcoins: activate to sort column ascending" style="width: 80px;">Coins</th>
                            ...
                            <tbody>
                                <?php foreach ($registros as $registro): ?>
                                    <tr role="row" class="even">
                                        ...
                                        <td><?php echo $ptt = $registro['executivo'] == 1 ? $registro['patente_executivo'] : $registro['patente']; ?></td>
