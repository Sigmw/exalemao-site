                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                <div class="nav-user-info" style="background: darkred;">
                                    <h5 class="mb-0 nav-user-name" style="color: beige;"><?php echo $viewData['acesso']->getInfo('nickname'); ?> </h5>
                                    <span class="status"></span><span class="ml-2" style="color: beige;">  
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <?php if ($viewData['acesso']->getInfo('patente') <= 12) : ?>
                                <li class="nav-item">
...
<!--
                            ...
                            <?php if ($viewData['acesso']->isExterno(1, $viewData['acesso']->getInfo('id_registro'))) : ?>
                                <li class="nav-item">
                                    <a class="nav-link <?php echo ($viewData['page_active'] == 'ajudantes') ? 'active' : ''; ?>" href="#" data-toggle="collapse" aria-expanded="false" data-target="#ajudantes-2" aria-controls="ajudantes-2"><i class="fab fa-adn"></i>Helper</a>
